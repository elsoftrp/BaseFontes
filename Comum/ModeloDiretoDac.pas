  ...
  begin
    ...
    begin
      ...
      begin
        ...
        try
          //Grava Log
        TOperacaoBD.GravalogDac(FConnection,TLib.DataServidor(FConnection), TUsuario.GetInstance.Id , TUsuario.GetInstance.Login,'Exclusão',FNomeTabela,Caption,TLib.CampoChave(vQuerydac,FCampoChave),
           TLib.CampoChave(vQuerydac,FCampoChave2), TLib.CampoChave(vQuerydac,FCampoChave3));
          //
          doGravaDataSets;
          vQuerydac.Delete;

...
begin
  ...
  begin
    ...
    vsDisplay      := ['Descrição do Grupo','Código'];
  end
  ...
  begin
    ...
    vsDisplay      := ['Descrição do Cartão','Código'];
  end
  ...
  begin
    ...
    vsDisplay      := ['Produto','Grupo','Código'];
  end
  ...
  begin
    ...
    vsCampos       := ['Despro','desgrupo',vsCampoRetorno];
    vsDisplay      := ['Produto','Grupo','Cód.Ean'];
  end
  ...
  begin
    ...
    vsDisplay      := ['Nome Cliente','CPF','Código'];
  end
  ...
  begin
    ...
    vsDisplay      := ['Tipo Adicional','Código'];
  end
  ...
  begin
    ...
    vsDisplay      := ['Razão Social','Fantasia','Código'];
  end
